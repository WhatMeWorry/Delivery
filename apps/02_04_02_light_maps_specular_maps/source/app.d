...
module app;  // 02_04_02_light_maps_specular_maps

import std.stdio : writeln; 
import std.math : fmax, abs, sin;
...
void main(string[] argv)
{
    ...
    auto winMain = glfwCreateWindow(width, height, "02_04_02_light_maps_specular_maps", null, null);
...
glfwSetFramebufferSizeCallback(winMain, &onFrameBufferResize);    
    ...
    alias generateTextureAndLoad = loadTexture;

    generateTextureAndLoad(diffuseMap, "../art/container2.png");     // relative to executable
    writeln("duffuseMap after loadTexture = ", diffuseMap);

    generateTextureAndLoad(specularMap, "../art/container2_specular.png");   
    writeln("specularMap after loadTexture = ", specularMap);

    // Set texture units
    glUseProgram(lightingShader);
    glUniform1i(glGetUniformLocation(lightingShader, "material.diffuse"),     0);
    glUniform1i(glGetUniformLocation(lightingShader, "material.specularMap"), 1);   
